Last Modification of this file is 02-apr-2015

UserMgmt is a User Management Plugin for cakephp 2.x
Plugin Premium version 2.3.3 (stable)
...
2. Schema import (use your favorite sql	tool to	import the schema)
	...
	yourapp/app/Plugin/Usermgmt/Config/Schema/usermgmt-2.3.3.sql
...
6. Download twitter bootstrap framework from http://getbootstrap.com/
...
copy all css and map files for e.g. bootstrap.css, bootstrap.min.css, bootstrap-theme.css, bootstrap-theme.min.css, bootstrap.css.map, bootstrap-theme.css.map
...
copy fonts folder
and paste it in to yourapp/app/webroot directory
...
/app/webroot/plugins/bootstrap-datepicker/build
---------------------------------------- /css
---------------------------------------- /js		etc
...
Directory structure should look like
/app/webroot/plugins/bootstrap-datetimepicker/build
-------------------------------------------- /css
-------------------------------------------- /js		etc

10. Download bootstrap chosen (green icon) file from https://github.com/harvesthq/chosen/releases/
extract this yourapp/app/webroot/plugins

Directory structure should look like
/app/webroot/plugins/chosen/chosen.css
...
Directory structure should look like
/app/webroot/plugins/bootstrap-ajax-typeahead/demo
-------------------------------------------- /js		etc

12. Download the jquery from http://jquery.com (at this time latest version is 1.11.2)
Please note I am using jquery-1.11.2.min.js in default layout if you download other jquery version then do not forget to change in default layout.
Directory structure should look like
/app/webroot/js/jquery-1.11.2.min.js


13. Download the tinymce editor from http://www.tinymce.com/download/download.php (at this time latest version is TinyMCE 4.1.9)
You will see 3 download button "TinyMCE 4.1.9", "TinyMCE 4.1.9 jQuery package", "TinyMCE 4.1.9 development package"
You should download it by "TinyMCE 4.1.9" button
...
Directory structure should look like
/app/webroot/js/tinymce/tinymce.min.js
---------------------- /plugins
---------------------- /langs	etc

14. Download the ckeditor (full package) editor from http://ckeditor.com/download (at this time latest version is ckeditor 4.4.7)
...
Directory structure should look like
/app/webroot/js/ckeditor/ckeditor.js
----------------------- /plugins
----------------------- /lang	etc
...
you can download the default layout from http://www.ektanjali.com/products/downloadLayout/umpremium2.3.3/bootstrap3
...
now open email.php find public $default
